      ...
      <div ref="scrollContainer" class="moves-scroll">
        ...
        >
          ...
          <div class="ply-wrapper" @click="selectWhite(index)">
            <!-- Skill star for white's brilliant move -->
            <svg v-if="move.classification" class="skill-star" viewBox="0 0 20 20" fill="none">
            ...
            >
              <span class="ply-text" :class="{ 'skill-text': move.classification }">{{ move.white }}</span>
            </div>
          </div>
